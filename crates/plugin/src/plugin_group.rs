...
use pi_world::prelude::{App, MultiThreadApp};
...
// #[cfg(test)]
// mod tests {
//     use crate::{plugin::Plugin, plugin_group::NoopPluginGroup};

//     use super::PluginGroupBuilder;
//     use pi_world::prelude::MultiThreadApp;
//     struct PluginA;
//     impl Plugin for PluginA {
//         fn build(&self, a_pp: &mut MultiThreadApp) {}
//     }

//     struct PluginB;
//     impl Plugin for PluginB {
//         fn build(&self, _: &mut MultiThreadApp) {}
//     }
